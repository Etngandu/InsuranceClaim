...
namespace ENB.InsuranceAndClaims.Entities.Collections
{
  ...
  /// </summary>
  public class ClaimsHeaders : CollectionBase<ClaimHeader>
  {
        /// <summary>
        /// Initializes a new instance of the <see cref="Operators"/> class.
        /// </summary>
        public ClaimsHeaders() { }

        /// <summary>
        /// Initializes a new instance of the <see cref="Operators"/> class.
        /// </summary>
        /// <param name="initialList">Accepts an IList of Person as the initial list.</param>
        public ClaimsHeaders(IList<ClaimHeader> initialList) : base(initialList) { }

        /// <summary>
        /// Initializes a new instance of the <see cref="Operators"/> class.
        /// </summary>
        /// <param name="initialList">Accepts a CollectionBase of Person as the initial list.</param>
        public ClaimsHeaders(CollectionBase<ClaimHeader> initialList) : base(initialList) { }
    ...
    public IEnumerable<ValidationResult> Validate()
    {
      ...
      foreach (var claimHeader in this)
      {
        errors.AddRange(claimHeader.Validate());
      }
      return errors;
    }
  }
