...
namespace ENB.InsuranceAndClaims.Entities.Collections
{
  ...
  /// </summary>
  public class ClaimsDocuments : CollectionBase<ClaimDocument>
  {
        /// <summary>
        ...
        public ClaimsDocuments(IList<ClaimDocument> initialList) : base(initialList) { }

        /// <summary>
        /// Initializes a new instance of the <see cref="Operators"/> class.
        /// </summary>
        /// <param name="initialList">Accepts a CollectionBase of Person as the initial list.</param>
        public ClaimsDocuments(CollectionBase<ClaimDocument> initialList) : base(initialList) { }
    ...
    public IEnumerable<ValidationResult> Validate()
    {
      ...
      foreach (var claimDocument in this)
      {
        errors.AddRange(claimDocument.Validate());
      }
      return errors;
    }
  }
