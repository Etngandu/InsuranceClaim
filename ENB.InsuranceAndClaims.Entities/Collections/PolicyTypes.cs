...
namespace ENB.InsuranceAndClaims.Entities.Collections
{
  ...
  /// </summary>
  public class PolicyTypes : CollectionBase<PolicyType>
  {
        /// <summary>
        ...
        public PolicyTypes(IList<PolicyType> initialList) : base(initialList) { }

        /// <summary>
        /// Initializes a new instance of the <see cref="Operators"/> class.
        /// </summary>
        /// <param name="initialList">Accepts a CollectionBase of Person as the initial list.</param>
        public PolicyTypes(CollectionBase<PolicyType> initialList) : base(initialList) { }
    ...
    public IEnumerable<ValidationResult> Validate()
    {
      ...
      foreach (var policytype in this)
      {
        errors.AddRange(policytype.Validate());
      }
      return errors;
    }
  }
