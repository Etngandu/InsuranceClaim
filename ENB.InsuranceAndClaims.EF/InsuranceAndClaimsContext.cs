...
using ENB.InsuranceAndClaims.EF.ConfigurationEntity;
...
namespace ENB.InsuranceAndClaims.EF
{
    ...
    /// </summary>
    public class InsuranceAndClaimsContext : IdentityDbContext<ApplicationUser>
    {
       

        public InsuranceAndClaimsContext(DbContextOptions<InsuranceAndClaimsContext>  options)
               :base(options)
        {
